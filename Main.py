...
if constants.identification=="svm":
    ...
    performanceEvaluation.evaluatePerformanceSVM(svclassifier,constants.methods,dataSet.testingDataImages,dataSet.testingDataWriters,classifiedCO3)
else:
    performanceEvaluation.evaluatePerformance(constants.methods,dataSet.testingDataImages,dataSet.testingDataWriters,featureVectors,dataSet.tariningDataWriters,classifiedCO3)
...
if constants.identification=="svm":
    writerId=SVMIdentification.identifyWriterSVM(svclassifier,constants.methods,writerImages[0],classifiedCO3)
else:
    writerId=knnIdentification.identifyWriter(constants.methods,featureVectors,dataSet.tariningDataWriters,writerImages[0],classifiedCO3)
